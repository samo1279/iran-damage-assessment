...
function ProbabilityPanel({ target, assessment, onClose }: ProbabilityPanelProps) {
  ...
  return (
    <div className="fixed inset-x-0 bottom-0 z-[99999] bg-card border-t-4 border-accent shadow-[0_-20px_50px_-10px_rgba(0,0,0,0.9)] animate-slideUp max-h-[85vh] overflow-y-auto rounded-t-3xl md:rounded-none">
      {/* Backdrop for mobile */}
...
export function MapView() {
  ...
  return (
    <div className="relative w-full h-full">
      ...
      {/* Analysis Panel - rendered via Portal to appear above everything */}
      {selectedTarget && createPortal(
        <ProbabilityPanel
